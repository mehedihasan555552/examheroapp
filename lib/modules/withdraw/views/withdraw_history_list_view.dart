...
class WithdrawHistoryListView extends GetView {
  WithdrawHistoryListView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Withdraw Histories'),
        centerTitle: true,
        backgroundColor: Theme.of(context).primaryColor,
      ),
      body: FutureBuilder(
        future: _withdrawController.loadWithdrawHistories(),
                        ...
                        child: ListTile(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            'Received Amount: ${double.parse(data['received_amount']).toStringAsFixed(2)} BDT'),
                                        const SizedBox(
                                          height: 8,
                                        ),
                                        Text(
                                            'Percent Charge: ${double.parse(data['payment_method']['percent_charge']).toStringAsFixed(2)} BDT'),
                                        const SizedBox(
                                          height: 8,
                                        ),
                                        Text(
                          ...
                          title: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Receivable: ${double.parse(data['received_amount'].toString()).toStringAsFixed(2)} BDT',
                                style: TextStyle(
                                  fontSize: 12,
